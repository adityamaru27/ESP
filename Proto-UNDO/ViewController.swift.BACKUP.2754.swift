...
@objc(ViewController) class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: Selector("dismissSelf"), name: "Child_Removed_Notification", object: nil)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        self.navigationItem.leftBarButtonItem =  UIBarButtonItem(title: child_fullname, style: UIBarButtonItemStyle.Plain, target: self, action: Selector("showChildView:"))
