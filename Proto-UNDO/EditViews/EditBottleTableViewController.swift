...
class EditBottleTableViewController: UITableViewController, UIPickerViewDelegate, UIPickerViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate , UITextFieldDelegate {
  ...
  //  @IBOutlet weak var lblDurationTitle: UILabel!
    ...
    func imagePickerController(picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]){
        ...
        let tapImage = UITapGestureRecognizer(target: self, action: #selector(EditBottleTableViewController.imageTapped(_:)))
...
//    }
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(EditBottleTableViewController.dataChanged), name: kLogObjectUpdatedNotification, object: nil)
        ...
        datePicker.addTarget(self, action: #selector(EditBottleTableViewController.datePickerValueChanged(_:)), forControlEvents: UIControlEvents.ValueChanged)
...
//            refreshViews()
    ...
    @IBAction func quantityChanged(sender: AnyObject) {
      ...
      //  lblQuantity.text = "\(Int(quantitySlider.value)) " + unit
